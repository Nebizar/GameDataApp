...
import pl.put.poznan.gamebase.service.impl.GameServiceImpl;
...
privileged aspect GameServiceImpl_Roo_Service_Impl {
    
    declare @type: GameServiceImpl: @Service;
    
    declare @type: GameServiceImpl: @Transactional(readOnly = true);
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private GameRepository GameServiceImpl.gameRepository;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private DLCService GameServiceImpl.dLCService;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private GamePlatService GameServiceImpl.gamePlatService;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private ReviewService GameServiceImpl.reviewService;
     ...
     */
    @Autowired
    public GameServiceImpl.new(GameRepository gameRepository, @Lazy DLCService dLCService, @Lazy GamePlatService gamePlatService, @Lazy ReviewService reviewService) {
     ...
     */
    public GameRepository GameServiceImpl.getGameRepository() {
        return gameRepository;
    }
     ...
     * @param gameRepository
     */
    public void GameServiceImpl.setGameRepository(GameRepository gameRepository) {
     ...
     * @return DLCService
     */
    public DLCService GameServiceImpl.getDLCService() {
        return dLCService;
    }
     ...
     * @param dLCService
     */
    public void GameServiceImpl.setDLCService(DLCService dLCService) {
     ...
     */
    public GamePlatService GameServiceImpl.getGamePlatService() {
        return gamePlatService;
    }
     ...
     * @param gamePlatService
     */
    public void GameServiceImpl.setGamePlatService(GamePlatService gamePlatService) {
     ...
     */
    public ReviewService GameServiceImpl.getReviewService() {
        return reviewService;
    }
     ...
     * @param reviewService
     */
    public void GameServiceImpl.setReviewService(ReviewService reviewService) {
     ...
     * @return Map
     */
    public Map<String, List<MessageI18n>> GameServiceImpl.validate(Game game) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.addToDlcs(Game game, Iterable<Long> dlcsToAdd) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.addToPlatforms(Game game, Iterable<Long> platformsToAdd) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.addToReviews(Game game, Iterable<Long> reviewsToAdd) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.removeFromDlcs(Game game, Iterable<Long> dlcsToRemove) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.removeFromPlatforms(Game game, Iterable<Long> platformsToRemove) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.removeFromReviews(Game game, Iterable<Long> reviewsToRemove) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.setDlcs(Game game, Iterable<Long> dlcs) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.setPlatforms(Game game, Iterable<Long> platforms) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.setReviews(Game game, Iterable<Long> reviews) {
     ...
     */
    @Transactional
    public void GameServiceImpl.delete(Game game) {
     ...
     */
    @Transactional
    public List<Game> GameServiceImpl.save(Iterable<Game> entities) {
     ...
     */
    @Transactional
    public void GameServiceImpl.delete(Iterable<Long> ids) {
     ...
     */
    @Transactional
    public Game GameServiceImpl.save(Game entity) {
     ...
     * @return Game
     */
    public Game GameServiceImpl.findOne(Long id) {
     ...
     * @return Game
     */
    public Game GameServiceImpl.findOneForUpdate(Long id) {
     ...
     * @return List
     */
    public List<Game> GameServiceImpl.findAll(Iterable<Long> ids) {
     ...
     * @return List
     */
    public List<Game> GameServiceImpl.findAll() {
     ...
     * @return Long
     */
    public long GameServiceImpl.count() {
     ...
     * @return Page
     */
    public Page<Game> GameServiceImpl.findAll(GlobalSearch globalSearch, Pageable pageable) {
     ...
     * @return Page
     */
    public Page<Game> GameServiceImpl.findAllByIdsIn(List<Long> ids, GlobalSearch globalSearch, Pageable pageable) {
     ...
     * @return Page
     */
    public Page<Game> GameServiceImpl.findByDevstudio(DevStudio devstudio, GlobalSearch globalSearch, Pageable pageable) {
     ...
     * @return Page
     */
    public Page<Game> GameServiceImpl.findByGametype(GameType gametype, GlobalSearch globalSearch, Pageable pageable) {
     ...
     * @return Long
     */
    public long GameServiceImpl.countByDevstudio(DevStudio devstudio) {
     ...
     * @return Long
     */
    public long GameServiceImpl.countByGametype(GameType gametype) {
     ...
     * @return Class
     */
    public Class<Game> GameServiceImpl.getEntityType() {
        return Game.class;
    }
     ...
     * @return Class
     */
    public Class<Long> GameServiceImpl.getIdType() {
        return Long.class;
    }
