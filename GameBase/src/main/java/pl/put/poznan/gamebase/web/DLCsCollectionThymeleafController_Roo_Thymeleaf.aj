...
privileged aspect DLCsCollectionThymeleafController_Roo_Thymeleaf {
    
    declare @type: DLCsCollectionThymeleafController: @Controller;
    
    declare @type: DLCsCollectionThymeleafController: @RequestMapping(value = "/dlcs", name = "DLCsCollectionThymeleafController", produces = MediaType.TEXT_HTML_VALUE);
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private DLCService DLCsCollectionThymeleafController.dLCService;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MessageSource DLCsCollectionThymeleafController.messageSource;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MethodLinkBuilderFactory<DLCsItemThymeleafController> DLCsCollectionThymeleafController.itemLink;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MethodLinkBuilderFactory<DLCsCollectionThymeleafController> DLCsCollectionThymeleafController.collectionLink;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private ConversionService DLCsCollectionThymeleafController.conversionService;
     ...
     */
    @Autowired
    public DLCsCollectionThymeleafController.new(DLCService dLCService, ConversionService conversionService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
     ...
     * @return DLCService
     */
    public DLCService DLCsCollectionThymeleafController.getDLCService() {
        return dLCService;
    }
     ...
     * @param dLCService
     */
    public void DLCsCollectionThymeleafController.setDLCService(DLCService dLCService) {
     ...
     */
    public MessageSource DLCsCollectionThymeleafController.getMessageSource() {
        return messageSource;
    }
     ...
     * @param messageSource
     */
    public void DLCsCollectionThymeleafController.setMessageSource(MessageSource messageSource) {
     ...
     */
    public MethodLinkBuilderFactory<DLCsItemThymeleafController> DLCsCollectionThymeleafController.getItemLink() {
        return itemLink;
    }
     ...
     * @param itemLink
     */
    public void DLCsCollectionThymeleafController.setItemLink(MethodLinkBuilderFactory<DLCsItemThymeleafController> itemLink) {
     ...
     * @return MethodLinkBuilderFactory
     */
    public MethodLinkBuilderFactory<DLCsCollectionThymeleafController> DLCsCollectionThymeleafController.getCollectionLink() {
     ...
     */
    public void DLCsCollectionThymeleafController.setCollectionLink(MethodLinkBuilderFactory<DLCsCollectionThymeleafController> collectionLink) {
     ...
     */
    public ConversionService DLCsCollectionThymeleafController.getConversionService() {
        return conversionService;
    }
     ...
     * @param conversionService
     */
    public void DLCsCollectionThymeleafController.setConversionService(ConversionService conversionService) {
    ...
    public ModelAndView DLCsCollectionThymeleafController.list(Model model) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<DLC>> DLCsCollectionThymeleafController.datatables(DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<DLC>> DLCsCollectionThymeleafController.datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<Select2DataSupport<DLC>> DLCsCollectionThymeleafController.select2(GlobalSearch search, Pageable pageable, Locale locale) {
        Page<DLC> dLCs = getDLCService().findAll(search, pageable);
     ...
     */
    @InitBinder("dLC")
    public void DLCsCollectionThymeleafController.initDLCBinder(WebDataBinder binder) {
     ...
     * @param model
     */
    public void DLCsCollectionThymeleafController.populateFormats(Model model) {
     ...
     * @param model
     */
    public void DLCsCollectionThymeleafController.populateForm(Model model) {
    ...
    public ModelAndView DLCsCollectionThymeleafController.create(@Valid @ModelAttribute DLC dLC, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
    ...
    public ModelAndView DLCsCollectionThymeleafController.createForm(Model model) {
        populateForm(model);
    ...
    @ResponseBody
    public ResponseEntity<?> DLCsCollectionThymeleafController.deleteBatch(@PathVariable("ids") Collection<Long> ids) {
     ...
     */
    public void DLCsCollectionThymeleafController.export(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, String[] datatablesColumns, HttpServletResponse response, JasperReportsExporter exporter, String fileName, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> DLCsCollectionThymeleafController.exportCsv(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> DLCsCollectionThymeleafController.exportPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> DLCsCollectionThymeleafController.exportXls(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
     ...
     */
    public void DLCsCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
