...
/**
 * = DLCsCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DLCsCollectionThymeleafController.class)
@Component
public class DLCsCollectionThymeleafLinkFactory implements MethodLinkFactory<DLCsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<DLCsCollectionThymeleafController> getControllerClass() {
