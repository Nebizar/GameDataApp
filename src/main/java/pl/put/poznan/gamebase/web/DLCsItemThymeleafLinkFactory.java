...
/**
 * = DLCsItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DLCsItemThymeleafController.class)
@Component
public class DLCsItemThymeleafLinkFactory implements MethodLinkFactory<DLCsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<DLCsItemThymeleafController> getControllerClass() {
