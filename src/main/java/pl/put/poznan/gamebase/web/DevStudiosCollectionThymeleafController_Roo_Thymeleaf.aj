...
privileged aspect DevStudiosCollectionThymeleafController_Roo_Thymeleaf {
    
    declare @type: DevStudiosCollectionThymeleafController: @Controller;
    
    declare @type: DevStudiosCollectionThymeleafController: @RequestMapping(value = "/devstudios", name = "DevStudiosCollectionThymeleafController", produces = MediaType.TEXT_HTML_VALUE);
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private DevStudioService DevStudiosCollectionThymeleafController.devStudioService;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MessageSource DevStudiosCollectionThymeleafController.messageSource;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MethodLinkBuilderFactory<DevStudiosItemThymeleafController> DevStudiosCollectionThymeleafController.itemLink;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MethodLinkBuilderFactory<DevStudiosCollectionThymeleafController> DevStudiosCollectionThymeleafController.collectionLink;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private ConversionService DevStudiosCollectionThymeleafController.conversionService;
     ...
     */
    @Autowired
    public DevStudiosCollectionThymeleafController.new(DevStudioService devStudioService, ConversionService conversionService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
     ...
     */
    public DevStudioService DevStudiosCollectionThymeleafController.getDevStudioService() {
        return devStudioService;
    }
     ...
     * @param devStudioService
     */
    public void DevStudiosCollectionThymeleafController.setDevStudioService(DevStudioService devStudioService) {
     ...
     */
    public MessageSource DevStudiosCollectionThymeleafController.getMessageSource() {
        return messageSource;
    }
     ...
     * @param messageSource
     */
    public void DevStudiosCollectionThymeleafController.setMessageSource(MessageSource messageSource) {
     ...
     */
    public MethodLinkBuilderFactory<DevStudiosItemThymeleafController> DevStudiosCollectionThymeleafController.getItemLink() {
        return itemLink;
    }
     ...
     * @param itemLink
     */
    public void DevStudiosCollectionThymeleafController.setItemLink(MethodLinkBuilderFactory<DevStudiosItemThymeleafController> itemLink) {
     ...
     * @return MethodLinkBuilderFactory
     */
    public MethodLinkBuilderFactory<DevStudiosCollectionThymeleafController> DevStudiosCollectionThymeleafController.getCollectionLink() {
     ...
     */
    public void DevStudiosCollectionThymeleafController.setCollectionLink(MethodLinkBuilderFactory<DevStudiosCollectionThymeleafController> collectionLink) {
     ...
     */
    public ConversionService DevStudiosCollectionThymeleafController.getConversionService() {
        return conversionService;
    }
     ...
     * @param conversionService
     */
    public void DevStudiosCollectionThymeleafController.setConversionService(ConversionService conversionService) {
    ...
    public ModelAndView DevStudiosCollectionThymeleafController.list(Model model) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<DevStudio>> DevStudiosCollectionThymeleafController.datatables(DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<DevStudio>> DevStudiosCollectionThymeleafController.datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<Select2DataSupport<DevStudio>> DevStudiosCollectionThymeleafController.select2(GlobalSearch search, Pageable pageable, Locale locale) {
        Page<DevStudio> devStudios = getDevStudioService().findAll(search, pageable);
    ...
    public void DevStudiosCollectionThymeleafController.initDevStudioBinder(WebDataBinder binder) {
     ...
     * @param model
     */
    public void DevStudiosCollectionThymeleafController.populateFormats(Model model) {
     ...
     * @param model
     */
    public void DevStudiosCollectionThymeleafController.populateForm(Model model) {
    ...
    public ModelAndView DevStudiosCollectionThymeleafController.create(@Valid @ModelAttribute DevStudio devStudio, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
    ...
    public ModelAndView DevStudiosCollectionThymeleafController.createForm(Model model) {
        populateForm(model);
    ...
    @ResponseBody
    public ResponseEntity<?> DevStudiosCollectionThymeleafController.deleteBatch(@PathVariable("ids") Collection<Long> ids) {
     ...
     */
    public void DevStudiosCollectionThymeleafController.export(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, String[] datatablesColumns, HttpServletResponse response, JasperReportsExporter exporter, String fileName, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> DevStudiosCollectionThymeleafController.exportCsv(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> DevStudiosCollectionThymeleafController.exportPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> DevStudiosCollectionThymeleafController.exportXls(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
     ...
     */
    public void DevStudiosCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
