...
/**
 * = DevStudiosCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DevStudiosCollectionThymeleafController.class)
@Component
public class DevStudiosCollectionThymeleafLinkFactory implements MethodLinkFactory<DevStudiosCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<DevStudiosCollectionThymeleafController> getControllerClass() {
