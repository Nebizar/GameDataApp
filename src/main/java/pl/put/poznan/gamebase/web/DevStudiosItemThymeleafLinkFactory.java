...
/**
 * = DevStudiosItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DevStudiosItemThymeleafController.class)
@Component
public class DevStudiosItemThymeleafLinkFactory implements MethodLinkFactory<DevStudiosItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<DevStudiosItemThymeleafController> getControllerClass() {
