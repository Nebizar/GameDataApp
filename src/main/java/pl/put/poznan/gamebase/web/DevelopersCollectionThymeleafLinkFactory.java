...
/**
 * = DevelopersCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DevelopersCollectionThymeleafController.class)
@Component
public class DevelopersCollectionThymeleafLinkFactory implements MethodLinkFactory<DevelopersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<DevelopersCollectionThymeleafController> getControllerClass() {
