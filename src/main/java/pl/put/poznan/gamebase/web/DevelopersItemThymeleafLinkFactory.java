...
/**
 * = DevelopersItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DevelopersItemThymeleafController.class)
@Component
public class DevelopersItemThymeleafLinkFactory implements MethodLinkFactory<DevelopersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<DevelopersItemThymeleafController> getControllerClass() {
        return DevelopersItemThymeleafController.class;
    }
