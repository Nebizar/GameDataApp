...
/**
 * = GamePlatsCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GamePlatsCollectionThymeleafController.class)
@Component
public class GamePlatsCollectionThymeleafLinkFactory implements MethodLinkFactory<GamePlatsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<GamePlatsCollectionThymeleafController> getControllerClass() {
