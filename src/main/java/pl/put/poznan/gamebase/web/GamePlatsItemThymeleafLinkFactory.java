...
/**
 * = GamePlatsItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GamePlatsItemThymeleafController.class)
@Component
public class GamePlatsItemThymeleafLinkFactory implements MethodLinkFactory<GamePlatsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<GamePlatsItemThymeleafController> getControllerClass() {
