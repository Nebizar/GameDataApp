...
/**
 * = GameTypesCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GameTypesCollectionThymeleafController.class)
@Component
public class GameTypesCollectionThymeleafLinkFactory implements MethodLinkFactory<GameTypesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<GameTypesCollectionThymeleafController> getControllerClass() {
