...
/**
 * = GameTypesItemGamesThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GameTypesItemGamesThymeleafController.class)
@Component
public class GameTypesItemGamesThymeleafLinkFactory implements MethodLinkFactory<GameTypesItemGamesThymeleafController> {
     ...
     * @return Class
     */
    public Class<GameTypesItemGamesThymeleafController> getControllerClass() {
