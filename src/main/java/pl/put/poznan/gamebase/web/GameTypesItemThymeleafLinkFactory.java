...
/**
 * = GameTypesItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GameTypesItemThymeleafController.class)
@Component
public class GameTypesItemThymeleafLinkFactory implements MethodLinkFactory<GameTypesItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<GameTypesItemThymeleafController> getControllerClass() {
        return GameTypesItemThymeleafController.class;
    }
