...
/**
 * = GamesCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GamesCollectionThymeleafController.class)
@Component
public class GamesCollectionThymeleafLinkFactory implements MethodLinkFactory<GamesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<GamesCollectionThymeleafController> getControllerClass() {
        return GamesCollectionThymeleafController.class;
    }
