...
/**
 * = GamesItemReviewsThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GamesItemReviewsThymeleafController.class)
@Component
public class GamesItemReviewsThymeleafLinkFactory implements MethodLinkFactory<GamesItemReviewsThymeleafController> {
     ...
     * @return Class
     */
    public Class<GamesItemReviewsThymeleafController> getControllerClass() {
