...
/**
 * = GamesItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GamesItemThymeleafController.class)
@Component
public class GamesItemThymeleafLinkFactory implements MethodLinkFactory<GamesItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<GamesItemThymeleafController> getControllerClass() {
