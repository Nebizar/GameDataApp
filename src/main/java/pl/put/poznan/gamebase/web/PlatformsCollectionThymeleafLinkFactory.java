...
/**
 * = PlatformsCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PlatformsCollectionThymeleafController.class)
@Component
public class PlatformsCollectionThymeleafLinkFactory implements MethodLinkFactory<PlatformsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<PlatformsCollectionThymeleafController> getControllerClass() {
        return PlatformsCollectionThymeleafController.class;
    }
