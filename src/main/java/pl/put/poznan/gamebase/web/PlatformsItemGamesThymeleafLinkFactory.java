...
/**
 * = PlatformsItemGamesThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PlatformsItemGamesThymeleafController.class)
@Component
public class PlatformsItemGamesThymeleafLinkFactory implements MethodLinkFactory<PlatformsItemGamesThymeleafController> {
     ...
     * @return Class
     */
    public Class<PlatformsItemGamesThymeleafController> getControllerClass() {
