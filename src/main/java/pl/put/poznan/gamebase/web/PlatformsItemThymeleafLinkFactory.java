...
/**
 * = PlatformsItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PlatformsItemThymeleafController.class)
@Component
public class PlatformsItemThymeleafLinkFactory implements MethodLinkFactory<PlatformsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<PlatformsItemThymeleafController> getControllerClass() {
