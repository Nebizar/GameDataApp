...
/**
 * = PublishersCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PublishersCollectionThymeleafController.class)
@Component
public class PublishersCollectionThymeleafLinkFactory implements MethodLinkFactory<PublishersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<PublishersCollectionThymeleafController> getControllerClass() {
