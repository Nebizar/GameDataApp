...
/**
 * = PublishersItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PublishersItemThymeleafController.class)
@Component
public class PublishersItemThymeleafLinkFactory implements MethodLinkFactory<PublishersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<PublishersItemThymeleafController> getControllerClass() {
