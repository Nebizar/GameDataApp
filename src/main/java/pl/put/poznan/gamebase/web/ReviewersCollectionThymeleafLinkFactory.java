...
/**
 * = ReviewersCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ReviewersCollectionThymeleafController.class)
@Component
public class ReviewersCollectionThymeleafLinkFactory implements MethodLinkFactory<ReviewersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ReviewersCollectionThymeleafController> getControllerClass() {
