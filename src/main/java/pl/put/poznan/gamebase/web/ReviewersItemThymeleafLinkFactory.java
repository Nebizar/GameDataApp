...
/**
 * = ReviewersItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ReviewersItemThymeleafController.class)
@Component
public class ReviewersItemThymeleafLinkFactory implements MethodLinkFactory<ReviewersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<ReviewersItemThymeleafController> getControllerClass() {
        return ReviewersItemThymeleafController.class;
    }
