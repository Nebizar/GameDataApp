...
/**
 * = ReviewsCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ReviewsCollectionThymeleafController.class)
@Component
public class ReviewsCollectionThymeleafLinkFactory implements MethodLinkFactory<ReviewsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ReviewsCollectionThymeleafController> getControllerClass() {
        return ReviewsCollectionThymeleafController.class;
    }
