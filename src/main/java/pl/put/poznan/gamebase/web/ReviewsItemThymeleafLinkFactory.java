...
/**
 * = ReviewsItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ReviewsItemThymeleafController.class)
@Component
public class ReviewsItemThymeleafLinkFactory implements MethodLinkFactory<ReviewsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<ReviewsItemThymeleafController> getControllerClass() {
        return ReviewsItemThymeleafController.class;
    }
